            ...
            if (bytes == -1 || bytes != sizeof(event_)) {
                ...
                if (event_.isButton()) {
                    ...
                    if (device_type > 0) { //RCs like FrSky Taranis
                        ...
                        switch (event_.number) {
                        case 0:
                            // Turn off left right turning (yaw) control
                        ...
                        case 1:
                            ...
                            break;
                        case 4:
                            // Switched this to case 4 to fix the controller issue with inputs
                        ...
                        case 3:
                            ...
                            break;
                        case 2:
                            // Turn off forward backward tilting (pitch?) control
                        ...
                        // Added this log for controller input.
                        // UE_LOG(LogTemp, Warning, TEXT("event_.number: %d"), event_.number);
                    }
                }
                //else ignore
            }
