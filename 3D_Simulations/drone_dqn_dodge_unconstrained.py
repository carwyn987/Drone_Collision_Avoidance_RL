...
def computeReward(pos_vector, collision):
    if not collision and abs(pos_vector.z_val) < 4:
        return 1, collision
...
model_dir = "models/"
model_path1 = "dqn_dodge_behavior_throttle_full.pth"
model_path2 = "dqn_dodge_behavior_roll_full.pth"
...
# Save model
torch.save(behavior_model.state_dict(), "models/dqn_dodge_behavior_throttle_full.pth")
torch.save(behavior_model_roll.state_dict(), "models/dqn_dodge_behavior_roll_full.pth")